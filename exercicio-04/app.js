...
/*
  ...
  caracteres? BOOLEAN."
*/
const currentNumber = 39

// console.log(`A string que a "typeSentence" armazena tem mais de ${currentNumber} caracteres? ${String(typeSentence.length > currentNumber).replace('t', 'T')}.`)
/*
