...
const animalsWith3Letters = animals
...
const animalNameLength = animals.map(({ length }) => length)
...
const nameFriendsNearMe = friendsNearMe.map(({ name }) => name)
...
const populationCountrySome = data
